...
import { signInWithGoogle, signInWithApple, checkRedirectResult } from '@/lib/firebase-client';
      ...
      <div className="max-w-md w-full animate-fade-in">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={signing}
            className="w-full bg-white text-black font-semibold py-4 rounded-xl text-sm tracking-wide hover:bg-white/90 transition-all cursor-pointer disabled:opacity-50 flex items-center justify-center gap-3"
          >
